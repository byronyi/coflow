...
// Slave <-> Master
private[coflow] case class SlaveCoflows(host: String, coflows: Map[String, Map[Flow, Long]]) extends CoflowMessage

private[coflow] case class FlowPriorityQueue(flows: Array[Flow]) extends CoflowMessage
